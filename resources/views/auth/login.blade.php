        ...
        <main class="container-fluid">
            <div class="row align-items-center">
                <div class= "col-md-6 d-none d-md-block p-0">
                        <img src="asset/images/login2.webp" id="fondo-login" alt="Real Madrid" class="img-fluid">
                </div>

                <div class="col-md-6 d-flex flex-column justify-content-center px-md-5  mb-5"> 
